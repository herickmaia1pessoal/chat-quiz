// Structural validation for the generated FunnelDocuments, independent of
// the SQL emission — mirrors the Postgres-side checks (apply_funnel_document
// + the published-funnel terminal-path rule) so problems surface locally
...
function validate(doc: FunnelDocument, label: string) {
